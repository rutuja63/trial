...
def get_params(proj4):
    from utils import identify_hemi_zone
    import pyproj
    crs_las = pyproj.CRS.from_proj4(proj4)
    epsg_las = crs_las.to_epsg()
...
def writeTif(xx,yy,zz,epsg,outputFile,formatArray=False):
    ...
    outputFile = "/exports/csce/datastore/geos/groups/MSCGIS/s2318635/NEON_laz_flighline/tiff/abc.tif"
    out_tif = rasterio.open(outputFile, 'w', driver='GTiff',
